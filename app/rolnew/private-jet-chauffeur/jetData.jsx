export const jetData = {
  ...
  luxuriousServiceData: [
    ...
    {
      img: '/rolnew/global/icons/jet/Free Waiting Time.png',
    ...
    {
      img: '/rolnew/global/icons/jet/Private Jet Tracking System.png',
      ...
      },
      {
        ...
        desc: (
          <p className="text-[#B2B2B2]">
            ...
            <br />
            <span className="ml-3 text-[#B2B2B2]">
              2. Private jet transfer Dubai
            </span>
            <br />
            <span className="ml-3 text-[#B2B2B2]">
              3. Private jet transfer Paris
            </span>
            <br />
            <span className="ml-3 text-[#B2B2B2]">
              4. Private jet transfer New York
            </span>
            <br />
            <span className="ml-3 text-[#B2B2B2]">
              5. Private jet transfer Tokyo
            </span>
          </p>
        ),
      },
