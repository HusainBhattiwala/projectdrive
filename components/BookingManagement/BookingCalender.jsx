...
function BookingCalender({ getSearchDataUsingDate, right }) {
  ...
  return (
    <div className="flex items-center md:border-r border-[#BDBDBD] sm:pr-4 md:px-2 px-1 sm:border-0 border h-[40px] rounded-md sm:rounded-none sm:bg-transparent bg-white justify-center sm:min-w-[120px]">
