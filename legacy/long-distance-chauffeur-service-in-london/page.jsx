...
const jsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target:
      'https://www.roldrive.com/search?q=long-distance-chauffeur-service-in-london{search_term_string}',
...
export default function Home() {
  return (
    <>
      ...
      <main>
        <BookingBannerV3
          img="/images/services/long-distance-chauffeur-service-in-london/banner.jpg"
       ...
       "
        ...
        <ImageTextRight
          sections={[
            {
              img: '/images/services/long-distance-chauffeur-service-in-london/unleash-true-luxury-through-a-full-day-chauffeur-hire-in-london.jpg',
        ...
        <ImageTextLeft
          sections={[
            {
              img: '/images/services/long-distance-chauffeur-service-in-london/why-choose-roldrive.jpg',
        ...
        {/*  { */}
        {/*    img: '/images/services/long-distance-chauffeur-service-in-london/best-facilities.jpg', */}
        ...
        {/*  { */}
        {/*    img: '/images/services/long-distance-chauffeur-service-in-london/booking-procedure.jpg', */}
