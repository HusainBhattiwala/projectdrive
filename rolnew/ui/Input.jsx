...
export default function Input({
  ...
  return (
    <div className={`w-full ${isFullScreen ? 'fixed h-full top-0 left-0 right-0 bottom-0 z-[99999999] bg-[#223544] py-4 px-4' : 'relative'}`}>
      {
        showError && (
      ...
      <div className="flex w-full gap-x-3 items-center">
        ...
        <button type="button" onClick={closeFocus}>
          <img alt="clear" src="/rolnew/global/icons/x.svg" className="w-6 h-6 cursor-pointer" />
        </button>
        )
      }
        <div className="relative flex-grow">
          ...
          <Component
            ...
            className={twMerge(
              ...
              } bg-[#223544] bg-opacity-85 !text-[#B2B2B2] border !border-[#E1E1E140] overflow-ellipsis autofill:!bg-[#223544D9] ${
                inputIcon && 'pr-12'
              } ${className}`,
            )}
            ref={inputRef}
