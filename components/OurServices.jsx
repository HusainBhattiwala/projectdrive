...
const services = [
  {
    id: 1,
    serviceImg: '/images/services/airporttransfers.jpg',
    serviceTitle: 'Airport transfers',
    serviceDesc: 'At RolDrive, we go above and beyond with our ',
    linkURL: '/private-chauffeur-service-in-london',
    linkText: 'private chauffeur service in london',
    serviceDesc2:
  ...
  },
  {
    ...
    serviceDesc: 'With our, ',
    linkURL: '/hourly-chauffeur-service',
    linkText: 'hourly chauffeur service',
    serviceDesc2:
  ...
  },
  {
    ...
    serviceDesc: 'Our luxury ',
    linkURL: '/chauffeur-service-in-london',
    linkText: 'chauffeur service in London',
    serviceDesc2:
  ...
  },
  {
    ...
    serviceDesc: "At RolDrive's ",
    linkURL: 'event-chauffeur-service-in-london',
    linkText: 'event chauffeur service in London, ',
    serviceDesc2:
...
function OurServices() {
  const serviceSlides = services.map((service) => (
    <div className="card w-full" key={service.id}>
      <div className="h-56">
        <Image
          ...
          className="overflow-hidden max-h-56 w-full !p-3 rounded-3xl  mx-auto"
        />
        {/* <Pic
          src={service.serviceImg}
          alt={service.serviceTitle}
          className="object-fill !max-h-48"
        /> */}
      </div>
      <div className="items-center px-2 py-2 text-center card-body xl:px-8 lg:px-4">
        <H2 className="mt-5 mb-1 font-bold capitalize text-primary">
          {service.serviceTitle}
        </H2>

        <span className="text-[14px] -mb-[6px] inline">
          {service.serviceDesc}
          <Link className="text-primary" href={service.linkURL}>
            {service.linkText}
          </Link>
        </span>
        <ReadMore
  ...
  return (
    <div className="bg-[#F0F2F7] xl:px-20 lg:px-10 md:px-8 sm:px-6 px-4 xl:pt-10 pt-8 pb-6 w-full">
      <div className="mx-auto text-center lg:container ">
        <H1 className="mb-8 font-bold text-black capitalize">Our services</H1>
        <CarouselWrapper
