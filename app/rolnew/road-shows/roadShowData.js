export const roadShowData = {
  ...
  topPicksData: {
    ...
    list: [
      {
        id: 1,
        image: "/rolnew/services/roadshows/RS_london.jpg",
        cityName: "Roadshow - London ",
        countryCode: "GB",
        address: "London",
      },
      {
        id: 2,
        image: "/rolnew/services/roadshows/RS_dubai.jpg",
        cityName: "Roadshow - Dubai",
        countryCode: "AE",
        address: "Dubai",
      },
      {
        id: 3,
        image: "/rolnew/services/roadshows/RS_newyork.jpg",
        cityName: "Roadshow - New York",
        countryCode: "US",
        address: "New York",
      },
      {
        id: 4,
        image: "/rolnew/services/roadshows/RS_paris.jpg",
        cityName: "Roadshow - Paris",
        countryCode: "FR",
        address: "Paris",
      },
      {
        id: 5,
        image: "/rolnew/services/roadshows/RS_tokyo.jpg",
        cityName: "Roadshow - Tokyo",
        countryCode: "JP",
        address: "Tokyo",
      },
    ],
    ...
    data: [
      {
        ...
        desc: (
          <p className="text-[#B2B2B2]">
            ...
            your locations in absolute comfort and style. <br /> <br />
