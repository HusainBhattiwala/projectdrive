...
export default function Page() {
  ...
  const faqData = {
    ...
    data: [
      ...
      {
        id: 6,
        question: 'What information do I need to provide when booking an airport transfer?',
      ...
      {
        id: 14,
        question: 'Can I use airport transfer services for both domestic and international flights?',
  ...
  const servicesData = {
    ...
    data: [
      ...
      {
        title: 'Difference between a chauffeured airport transfer and hailing a cab to the airport.',
