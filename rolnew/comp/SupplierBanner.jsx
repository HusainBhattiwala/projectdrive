    ...
    <div className="relative bg-[#223544] h-[67rem] xl:min-h-screen xl:h-[52rem]">
      ...
      <div className='min-h-screen h-[995px] max-w-[90rem] mx-auto my-auto'>
        <div className='sm:container sm:mx-auto top-4 lg:ml-4'>
          <div className='absolute w-1/2 z-[2] my-auto mx-auto top-[170px] xs:top-[280px] xs:w-[85%] xs:left-[40px] '>
            <div className='w-full md:mt-8 mx-auto left-0'>
              <div className="md:w-3/4 xs:w-full sm:w-full ">
                  ...
                  <h1 className="sm:block font-sans text-[34px] font-bold leading-[40px] text-[#FFF8F3] md:hidden">
                    Providing exclusive and dependable chauffeur service indulgence
                  </h1>
          ...
          <div className='absolute w-[450px] h-[626px] z-[2] my-auto top-[100px] right-[150px] mx-auto lg:right-[100px] md:[right-80px] sm:right-0 md:ml-[80px]'>
            <div className='w-full mt-26 bottom-0 mx-auto '>
            <div className="hidden md:block lg:w-full mx-auto">
