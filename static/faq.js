    ...
    faqData: [
      {
        ...
        ans: 'Booking with RolDrive, renowned for offering the best chauffeur service, is a streamlined process designed for client convenience and satisfaction. Book RolDrive’s chauffeur service through our official website or mobile app, where you can select your desired service, date, time, and vehicle preference.',
      },
      {
        question: 'When will I receive my chauffeur and vehicle details?',
        ans: 'We assign a chauffeur/vehicle 24 hours before the booking date and time, and an email with the chauffeur and vehicle details will be sent to you.',
      },
      {
        question:
    ...
    faqData: [
      {
        ...
        ans: 'For any cancellations, please access your RolDrive online account via the website or app to cancel your ride.',
      },
      {
        question:
          'How many hours in advance do I need to cancel RolDrive’s chauffeur service in order to receive a full refund?',
        ans: 'To receive a full refund, please cancel your RolDrive chauffeur service booking at least 12 hours before booking time.',
      },
    ],
  },
  {
    ...
    faqData: [
      ...
      },
      {
        ...
        ans: 'For the complete RolDrive experience for your VVIP passenger. We recommend the Rolls Royce Phantom VIII, Mercedes Maybach or Bentley Mulsanne. These cars come with high-end amenities that will make your VVIP passenger feel like royalty.',
      },
      {
        question: 'Do you allow pets inside the vehicle?',
        ans: 'Yes, we provide pet-friendly chauffeurs on demand. Please inform us when booking.',
      },
      {
        question: 'How old will my RolDrive chauffeured vehicle be?',
        ans: 'All of RolDrive’s chauffeured vehicles are less than three years old, and we generally send the most recent model in the industry at the time.',
      },
      {
        question: 'What is the luggage capacity of the vehicle I am booking?',
        ans: 'To know more about our vehicle luggage capacity, please visit our fleet section on the Home page where all the details are present for every vehicle we offer.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    faqData: [
      ...
      },
      {
        ...
        ans: 'Yes, your RolDrive chauffeur will gladly offer assistance with your luggage.',
      },
      {
        question: 'Does a RolDrive chauffeur wear a suit and tie?',
        ans: 'Yes, always. RolDrive chauffeurs must adhere to a strict dress code of wearing a suit and tie.',
      },
      {
        question: 'Will I be notified when my RolDrive chauffeur arrives?',
        ans: 'Yes, as soon as your RolDrive chauffeur arrives, an email will be sent to your registered email address. Your chauffeur will also send you a text message with his/her exact location, which is usually just outside the pick-up address.',
      },
    ],
  },
  {
    ...
    faqData: [
      ...
      },
      {
        ...
        ans: 'No, all charges are included in the booking price. We have a no-hidden-costs policy at RolDrive.',
      },
      {
        question: 'What happens if my flight details change?',
        ans: 'Please call or email us and we will update your reservation with the new flight information.',
      },
      {
        question:
          'My flight will be arriving early. Will my RolDrive chauffeur be there for me?',
        ans: 'Yes, your RolDrive chauffeur will monitor your flight and make certain that your chauffeur is in the arrivals hall before you leave customs.',
      },
    ],
  },
];
