  ...
  return (
    ...
    >
      <div className="flex items-stretch justify-between gap-4 sm:gap-6">
        ...
        <div className="flex flex-col w-1/4 gap-2 cursor-pointer" onClick={() => router.push('/profile-management')}>
          <img
        ...
        <div className="flex flex-col w-1/4 gap-2 cursor-pointer" onClick={() => router.push('/booking-management')}>
          <img
        ...
        <div className="flex flex-col w-1/4 gap-2 cursor-pointer" onClick={() => { router.push('/booking-management?param=new-booking'); setShowNewBooking(!showNewBooking); }}>
          <img
