...
export default function Hero2() {
  ...
  return (
    <div
      className={`relative mt-[72px] flex flex-col w-full md:min-h-[580px] lg:max-h-[90svh] overflow-hidden 2xl:min-h-[92svh] max-h-fit bg-[#11202d] ${focus && 'z-50'}`}
    >
      <div
      ...
      <div className="grow relative z-[1] md:flex items-end sm:pb-[58pxpx] pb-0 hidden">
        ...
        {
        width >= 768
        && <div className="2xl:bg-cover bg-cover bg-top absolute 2xl:bg-no-repeat top-0 left-0 bottom-0 right-0" style={{ backgroundImage: width <= 1536 ? 'url("/rolnew/home/bannerv2.svg")' : 'url("/rolnew/home/bannerv2.svg")' }} />
      }
