                ...
                trustedPartnersData.map((item, index) => (
                  <div className="col-span-1" key={index}>
                    ...
                    <div className="sm:mt-6 mt-2 text-[#B2B2B2] leading-5">
                      <h4 className="sm:text-xl text-md font-medium text-[#B2B2B2]">
                        {item?.title}
                      </h4>
