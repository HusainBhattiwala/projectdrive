  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        img: '/rolnew/fleet/luxury class/l4.png',
      },
    ],
  },
  {
    ...
    options: [
      {
        name: 'Tesla Model X',
        desc: 'The Tesla Model X for long range travelling is an ideal full-size luxury electric SUV known for its cutting-edge technology, sleek design, and long-distance range. It has a large panoramic windshield, a spacious interior, and falcon-wing doors. It has a fully electric powertrain that provides instant torque and acceleration. It also includes advanced driver assistance. It is widely regarded as one of the best electric SUVs on the market.',
        img: '/rolnew/fleet/electric class/e1.png',
      },
      {
        name: 'Tesla Model Y',
        desc: 'The Tesla Model Y for long range travelling is another all-electric compact SUV from our fleet. It has a modern design, cutting-edge technology, and high-performance capabilities. It has received numerous awards for its environmental impact and innovation. The Model Y has a roomy interior and a versatile liftback design. It is a slightly less expensive option than the Model X.',
        img: '/rolnew/fleet/electric class/e2.png',
      },
      {
        name: 'Tesla Model S',
        desc: 'The Tesla Model S is an all-electric luxury sedan. It has a modern design, cutting-edge technology, and high-performance capabilities. It has received numerous awards for its environmental impact and innovation. Book us for a Tesla Model S in London.',
        img: '/rolnew/fleet/electric class/e3.png',
      },
    ],
  },
  {
