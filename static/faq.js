export const homePageFaq = [
  {
    ...
    faqData: [
      {
        question: 'How can I book a chauffeur service with RolDrive?',
        answer:
          'Booking with RolDrive, renowned for offering the best chauffeur service, is a streamlined process designed for client convenience and satisfaction. Book RolDrive’s chauffeur service through our official website or mobile app, where you can select your desired service, date, time, and vehicle preference.',
      },
      {
        question: 'When will I receive my chauffeur and vehicle details?',
        answer:
          'We assign a chauffeur/vehicle 24 hours before the booking date and time, and an email with the chauffeur and vehicle details will be sent to you.',
      },
      {
        question:
          'Is advance booking required for RolDrive’s luxury chauffeur service?',
        answer:
          "Advance booking for RolDrive's luxury chauffeur service is highly recommended to ensure that you secure a vehicle that suits your specific needs and preferences. Early reservation allows for a more personalised service, giving RolDrive ample time to understand and prepare for any special requests you may have, whether it's a preference for a particular type of vehicle, the need for child seats, or accommodating extra luggage. It also ensures availability, particularly during peak periods or special events when demand for luxury chauffeur services spikes.",
      },
      {
        question:
          'What information do I need to provide when booking a ride with RolDrive?',
        answer:
          'When booking a chauffeur service with RolDrive, it’s important to provide comprehensive information to ensure the service is tailored to your specific needs. This includes your pickup and drop-off locations to plan the route accurately, the desired date and time of the service to schedule your journey, and the number of passengers to select an appropriately sized vehicle. Additionally, specifying any special requirements, such as child seats for young travellers or extra luggage space for those carrying more items, helps RolDrive customise the experience. Providing detailed information during booking enables RolDrive to offer a personalised, efficient, and comfortable chauffeur service, aligning with our commitment to excellence in customer satisfaction.',
      },
    ],
  },
  {
    ...
    faqData: [
      {
        question: 'How do I cancel a RolDrive chauffeur service booking?',
        answer:
          'For any cancellations, please access your RolDrive online account via the website or app to cancel your ride.',
      },
      {
        question:
          'How many hours in advance do I need to cancel RolDrive’s chauffeur service in order to receive a full refund?',
        answer:
          'To receive a full refund, please cancel your RolDrive chauffeur service booking at least 12 hours before booking time.',
      },
    ],
  },
  {
    ...
    faqData: [
      ...
      {
        question:
          'The passenger is VVIP. What vehicle does RolDrive recommend?',
        answer:
          'For the complete RolDrive experience for your VVIP passenger. We recommend the Rolls Royce Phantom VIII, Mercedes Maybach or Bentley Mulsanne. These cars come with high-end amenities that will make your VVIP passenger feel like royalty.',
      },
      {
        question: 'Do you allow pets inside the vehicle?',
        answer:
          'Yes, we provide pet-friendly chauffeurs on demand. Please inform us when booking.',
      },
      {
        question: 'How old will my RolDrive chauffeured vehicle be?',
        answer:
          'All of RolDrive’s chauffeured vehicles are less than three years old, and we generally send the most recent model in the industry at the time.',
      },
      {
        question: 'What is the luggage capacity of the vehicle I am booking?',
        answer:
          'To know more about our vehicle luggage capacity, please visit our fleet section on the Home page where all the details are present for every vehicle we offer.',
      },
    ],
  },
  {
    ...
    faqData: [
      {
        ...
        answer:
          'We accept all major credit and debit cards for payments. Contact our finance department for direct bank transfer at booking@roldrive.com',
      },
    ],
  },
  {
    ...
    faqData: [
      {
        question: 'Are RolDrive’s chauffeurs trained at defensive driving?',
        answer:
      ...
      },
      {
        ...
        answer:
          'Yes, your RolDrive chauffeur will gladly offer assistance with your luggage.',
      },
      {
        question: 'Does a RolDrive chauffeur wear a suit and tie?',
        answer:
          'Yes, always. RolDrive chauffeurs must adhere to a strict dress code of wearing a suit and tie.',
      },
      {
        question: 'Will I be notified when my RolDrive chauffeur arrives?',
        answer:
          'Yes, as soon as your RolDrive chauffeur arrives, an email will be sent to your registered email address. Your chauffeur will also send you a text message with his/her exact location, which is usually just outside the pick-up address.',
      },
    ],
  },
  {
    faqCat: 'Airport Related',
    faqData: [
      {
        question:
          "I'm flying from the United Kingdom. How many hours should I arrive at the airport before my flight?",
        answer:
          'Most airlines recommend arriving three hours before an international flight and two hours before a domestic flight. If you checked in online, the latest arrival times for international flights are 2 hours and 1.5 hours prior for domestic flights.',
      },
      {
        question: 'Where will I meet my chauffeur?',
        answer:
          "Your RolDrive chauffeur will be waiting at arrivals with your name on a paging board as soon as the flight lands. Your chauffeur will also send you an SMS message with the exact meeting location information. You will also receive these details via email, along with your chauffeur's exact GPS location within the terminal.",
      },
      {
        question: 'My flight is delayed, will my chauffeur wait for me?',
        answer:
          'We monitor your flight, no matter early or delayed, we will send your chauffeur to the arrival hall with your name on a paging board as soon as the flight lands. We also offer free 60 minutes waiting time in case the chauffeur arrives and there are flight delays.',
      },
      {
        question: 'Will I be charged for tolls and parking by RolDrive?',
        answer:
          'No, all charges are included in the booking price. We have a no-hidden-costs policy at RolDrive.',
      },
      {
        question: 'What happens if my flight details change?',
        answer:
          'Please call or email us and we will update your reservation with the new flight information.',
      },
      {
        question:
          'My flight will be arriving early. Will my RolDrive chauffeur be there for me?',
        answer:
          'Yes, your RolDrive chauffeur will monitor your flight and make certain that your chauffeur is in the arrivals hall before you leave customs.',
      },
    ],
  },
];
