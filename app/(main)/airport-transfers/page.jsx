...
export default function Page() {
  ...
  const topPicksData = {
    ...
    list: [
      ...
      },
      {
        ...
        image: '/rolnew/global/country/London_Stansted_Airport.jpg',
        countryCode: 'US',
        cityName: 'New York Airport',
      },
      {
        id: 4,
        image: '/rolnew/global/country/Luton_Airport.jpg',
        countryCode: 'FR',
        cityName: 'Paris Airport',
      },
      {
        id: 5,
        image: '/rolnew/global/country/Heathrow_Airport.jpg',
        countryCode: 'JP',
        cityName: 'Tokyo Airport',
      },
  ...
  const faqData = {
    ...
    data: [
      ...
      //   ans: 'Tips are not always included in the airport transfer cost. Clarify this with the service provider or check their guidelines so you donâ€™t face any sudden expenses.',
      // },
      // {
      //   id: 13,
